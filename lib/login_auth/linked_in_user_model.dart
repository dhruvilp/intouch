...
import 'linked_in_auth_response_wrapper.dart';
...
class LinkedInUserModel {
  ...
  factory LinkedInUserModel.fromJson(Map<String, dynamic> json) {
    ...
    return LinkedInUserModel(
      firstName: firstName != null ? _LinkedInPersonalInfo.fromJson(firstName) : null,
      lastName: lastName != null ? _LinkedInPersonalInfo.fromJson(lastName) : null,
...
class _LinkedInPersonalInfo {
  ...
  factory _LinkedInPersonalInfo.fromJson(Map<String, dynamic> json) =>
      _LinkedInPersonalInfo(
        ...
        preferredLocal: _LinkedInPreferredLocal.fromJson(json['preferredLocale']),
      );
